...
export default function TermsPage({ currentLanguage: lang, darkMode, onBack }: Props) {
  ...
  const sections = isTR ? [
    ...
    { title: '8. Uygulanacak Hukuk', content: 'Bu sözleşme Türkiye Cumhuriyeti hukukuna tabidir. Anlaşmazlıklar önce arabuluculuk yoluyla çözülmeye çalışılır; çözüme kavuşturulamazsa Antalya Mahkemeleri ve İcra Daireleri yetkilidir.' }
  ] : [
    ...
    { title: '5. Intellectual Property', content: 'CETPA Cloud ERP software, interface design, logos and content are the exclusive property of CETPA A.Ş. and are protected by copyright and other intellectual property laws. Users are granted only a limited, non-transferable personal use licence. Copying, distributing or creating derivative works outside the licence scope is prohibited.' },
    ...
    { title: '8. Governing Law', content: 'This agreement is governed by the laws of the Republic of Turkey. Disputes will first be attempted to be resolved through mediation; if unresolved, Antalya Courts and Enforcement Offices shall have jurisdiction.' }
  ];
