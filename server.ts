...
import {
  ...
  getMikroCreds, getMikroToken, mikroSatirlar, sqlTanimlayici,
  mikroSql, mikroKolonlar, kolonBul, mikroPost, mikroTokenCacheMap,
...
async function startServer() {
  ...
  mikroRoutes(app, {
    ...
    getUserCompanyId, mikroIdCozucuIds, validate, GelenFaturaActionSchema,
  });
