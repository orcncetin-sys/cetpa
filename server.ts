...
import {
  initMikroMirror, initMikroTables, mirrorMikroInsert, CHA_COLS, STH_COLS,
} from "./src/server/mikroMirror.js";
import {
  initMikroClient, MIKRO_JUMP_SURUM, MIKRO_API_BASE, MIKRO_LOCAL_MODE,
  getMikroCreds, getMikroToken,
  mikroBugun, mikroSatirlar, mikroHata, sqlTarih, sqlTanimlayici,
  mikroSql, mikroKolonlar, mikroVergiOranlari, vergiOraniCoz, kolonBul, mikroPost, mikroTokenCacheMap,
...
import { kolonSec } from "./src/lib/mikroKolon.js";
...
async function startServer() {
  ...
  // Mikro rota grubu (21 uc) src/server/routes/mikroRoutes.ts'te.
  ...
  mikroRoutes(app, {
    ...
    getUserCompanyId, mikroIdCozucuIds,
  });
